...
- ~~this uses an insane amount of memory. lmao. it needs a big refactor. like my whole control flow needs redoing~~ solved! the problem was in the goroutine. Control flow redo may still come eventually, I kind of hate the way this program is structured in retrospect. Too many loops.
